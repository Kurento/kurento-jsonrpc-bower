...
function JsonRpcClient(e){function n(){Logger.info("notReconnectIfNumLessThan = "+c+" (old="+s+")"),s=c}function o(){if(N){var o=null;0!=c&&c!=s||(o={interval:e.heartbeat||PING_INTERVAL}),c++,i.send("ping",o,function(e){return function(o,r){o&&(Logger.info("Error in ping request #"+e+" ("+o.message+")"),e>s&&(N=!1,n(),Logger.info("Server did not respond to ping message #"+e+". Reconnecting... "),d.reconnectWs()))}}(c))}else Logger.info("Trying to send ping, but ping is not enabled")}function r(){a||(Logger.info("Starting ping (if configured)"),a=!0,void 0!=e.heartbeat&&(t=setInterval(o,e.heartbeat),o()))}var t,i=this,g=e.ws,s=-1,c=0,N=!0,a=!1,u=DISCONNECTED,C=g.onreconnecting,E=g.onreconnected,f=g.onconnected,l=g.onerror;e.rpc.pull=function(e,n){n.reply(null,"push")},g.onreconnecting=function(){if(Logger.info("--------- ONRECONNECTING -----------"),u===RECONNECTING)return void Logger.error("Websocket already in RECONNECTING state when receiving a new ONRECONNECTING message. Ignoring it");u=RECONNECTING,C&&C()},g.onreconnected=function(){if(Logger.info("--------- ONRECONNECTED -----------"),u===CONNECTED)return void Logger.error("Websocket already in CONNECTED state when receiving a new ONRECONNECTED message. Ignoring it");u=CONNECTED,N=!0,n(),r(),E&&E()},g.onconnected=function(){if(Logger.info("--------- ONCONNECTED -----------"),u===CONNECTED)return void Logger.error("Websocket already in CONNECTED state when receiving a new ONCONNECTED message. Ignoring it");u=CONNECTED,N=!0,r(),f&&f()},g.onerror=function(e){Logger.info("--------- ONERROR -----------"),u=DISCONNECTED,l&&l(e)};var d=new WebSocketWithReconnection(g);Logger.info("Connecting websocket to URI: "+g.uri);var O={request_timeout:e.rpc.requestTimeout,ping_request_timeout:e.rpc.heartbeatRequestTimeout},R=new RpcBuilder(RpcBuilder.packers.JsonRPC,O,d,function(n){Logger.trace("Received request: "+JSON.stringify(n));try{var o=e.rpc[n.method];void 0===o?Logger.error("Method "+n.method+" not registered in client"):o(n.params,n)}catch(e){Logger.error("Exception processing request: "+JSON.stringify(n)),Logger.error(e)}});this.send=function(e,n,o){"ping"!==e&&Logger.trace("Request: method:"+e+" params:"+JSON.stringify(n));var r=Date.now();R.encode(e,n,function(t,i){if(t){try{Logger.error("ERROR:"+t.message+" in Request: method:"+e+" params:"+JSON.stringify(n)+" request:"+t.request),t.data&&Logger.error("ERROR DATA:"+JSON.stringify(t.data))}catch(e){}t.requestTime=r}o&&(void 0!=i&&"pong"!==i.value&&Logger.trace("Response: "+JSON.stringify(i)),o(t,i))})},this.close=function(){Logger.info("Closing jsonRpcClient explicitly by client"),void 0!=t&&(Logger.info("Clearing ping interval"),clearInterval(t)),a=!1,N=!1,e.sendCloseMessage?(Logger.info("Sending close message"),this.send("closeSession",null,function(e,n){e&&Logger.error("Error sending close message: "+JSON.stringify(e)),d.close()})):d.close()},this.forceClose=function(e){d.forceClose(e)},this.reconnect=function(){d.reconnectWs()}}var RpcBuilder=require("../.."),WebSocketWithReconnection=require("./transports/webSocketWithReconnection");Date.now=Date.now||function(){return+new Date};var PING_INTERVAL=5e3,RECONNECTING="RECONNECTING",CONNECTED="CONNECTED",DISCONNECTED="DISCONNECTED",Logger=console;module.exports=JsonRpcClient;
...
(function (process){
"use strict";var debug=function(){};"production"!==process.env.NODE_ENV&&(debug=require("debug")("sockjs-client:utils:transport")),module.exports=function(e){return{filterToEnabled:function(t,r){var n={main:[],facade:[]};return t?"string"==typeof t&&(t=[t]):t=[],e.forEach(function(e){if(e)return"websocket"===e.transportName&&!1===r.websocket?void debug("disabled from server","websocket"):t.length&&-1===t.indexOf(e.transportName)?void debug("not in whitelist",e.transportName):void(e.enabled(r)?(debug("enabled",e.transportName),n.main.push(e),e.facadeTransport&&n.facade.push(e.facadeTransport)):debug("disabled",e.transportName))}),n}}};
}).call(this,require('_process'))
