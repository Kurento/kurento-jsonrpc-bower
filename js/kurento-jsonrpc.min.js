...
"use strict";function URL(t,e,o){if(!(this instanceof URL))return new URL(t,e,o);var r,s,n,i,a=relativere.test(t),p=typeof e,u=this,h=0;for("object"!==p&&"string"!==p&&(o=e,e=null),o&&"function"!=typeof o&&(o=qs.parse),e=lolcation(e);h<instructions.length;h++)s=instructions[h],r=s[0],i=s[1],r!==r?u[i]=t:"string"==typeof r?~(n=t.indexOf(r))&&("number"==typeof s[2]?(u[i]=t.slice(0,n),t=t.slice(n+s[2])):(u[i]=t.slice(n),t=t.slice(0,n))):(n=r.exec(t))&&(u[i]=n[1],t=t.slice(0,t.length-n[0].length)),u[i]=u[i]||(s[3]||"port"===i&&a?e[i]||"":""),s[4]&&(u[i]=u[i].toLowerCase());o&&(u.query=o(u.query)),required(u.port,u.protocol)||(u.host=u.hostname,u.port=""),u.username=u.password="",u.auth&&(s=u.auth.split(":"),u.username=s[0]||"",u.password=s[1]||""),u.href=u.toString()}var required=_dereq_("requires-port"),lolcation=_dereq_("./lolcation"),qs=_dereq_("querystringify"),relativere=/^\/(?!\/)/,instructions=[["#","hash"],["?","query"],["//","protocol",2,1,1],["/","pathname"],["@","auth",1],[NaN,"host",void 0,1,1],[/\:(\d+)$/,"port"],[NaN,"hostname",void 0,1,1]];URL.prototype.set=function(t,e,o){var r=this;return"query"===t?("string"==typeof e&&e.length&&(e=(o||qs.parse)(e)),r[t]=e):"port"===t?(r[t]=e,required(e,r.protocol)?e&&(r.host=r.hostname+":"+e):(r.host=r.hostname,r[t]="")):"hostname"===t?(r[t]=e,r.port&&(e+=":"+r.port),r.host=e):"host"===t?(r[t]=e,/\:\d+/.test(e)&&(e=e.split(":"),r.hostname=e[0],r.port=e[1])):r[t]=e,r.href=r.toString(),r},URL.prototype.toString=function(t){t&&"function"==typeof t||(t=qs.stringify);var e,o=this,r=o.protocol+"//";return o.username&&(r+=o.username,o.password&&(r+=":"+o.password),r+="@"),r+=o.hostname,o.port&&(r+=":"+o.port),r+=o.pathname,e="object"==typeof o.query?t(o.query):o.query,e&&(r+="?"!==e.charAt(0)?"?"+e:e),o.hash&&(r+=o.hash),r},URL.qs=qs,URL.location=lolcation,module.exports=URL;
//# sourceMappingURL=kurento-jsonrpc.map
